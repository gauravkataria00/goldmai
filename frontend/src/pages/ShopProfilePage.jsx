    ...
    <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 p-6 md:grid-cols-5 md:p-8">
          <div className="space-y-4 md:col-span-3">
            <p className="text-black dark:text-white">
              <span className="text-gray-600 dark:text-gray-400">Owner:</span> {shop.ownerName}
            </p>
            <p className="text-black dark:text-white">
              <span className="text-gray-600 dark:text-gray-400">Location:</span> {shop.area}, {shop.location}
            </p>
            <p className="text-black dark:text-white">
              <span className="text-gray-600 dark:text-gray-400">Address:</span> {shop.fullAddress}
            </p>
            <p className="text-black dark:text-white">
              <span className="text-gray-600 dark:text-gray-400">Years in business:</span> {shop.yearsInBusiness}+
            </p>
            <p className="text-black dark:text-white">
              <span className="text-gray-600 dark:text-gray-400">Opening hours:</span> {shop.openingHours}
            </p>

            <p className="leading-relaxed text-gray-600 dark:text-gray-400">{shop.description}</p>
          ...
          <div className="md:col-span-2">
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white/80 dark:border-yellow-500/20 dark:bg-black/40">
      ...
      <div className="mt-12">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="font-serif text-2xl font-bold text-black dark:text-white sm:text-3xl">Products</h2>
