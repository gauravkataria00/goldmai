      ...
      <div className="overflow-hidden rounded-2xl border border-gold-500/25 bg-zinc-950/80 p-6 sm:p-8">
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-300">Fabric: {product.fabric}</p>
              ...
              <div className="flex flex-wrap gap-2">
                {product.sizes?.map((size) => (
                  <button
                    ...
                    className={`rounded-lg border px-3 py-1.5 text-sm font-medium ${selectedSize === size ? 'border-gold-400 bg-gold-500/20 text-gold-300' : 'border-gold-500/20 text-zinc-300'}`}
                  >
                    {size}
                  </button>
                ))}
              ...
              <div className="flex flex-wrap gap-2">
                {product.colors?.map((color) => (
                  <button
                    ...
                    className={`rounded-lg border px-3 py-1.5 text-sm ${selectedColor === color ? 'border-gold-400 bg-gold-500/20 text-gold-300' : 'border-gold-500/20 text-zinc-300'}`}
                  >
                    {color}
                  </button>
                ))}
