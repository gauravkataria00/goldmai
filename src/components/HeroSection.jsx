    ...
    <section className="hero-bg min-h-screen flex items-center py-20 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-5xl animate-fade-in">
          ...
          {/* Main Heading - BIGGER */}
          <h1 className="heading-font text-7xl sm:text-8xl md:text-9xl lg:text-9xl leading-tight font-black text-white tracking-tighter mb-8 animate-slide-in-left" style={{ animationDelay: '0.3s', animationFillMode: 'both', lineHeight: '1.1' }}>
          ...
          <div className="mt-16 flex flex-wrap gap-6 animate-slide-in-left" style={{ animationDelay: '0.7s', animationFillMode: 'both' }}>
            <Link to="/shop" className="gold-button font-bold px-12 py-7 rounded-3xl text-xl flex items-center gap-4 shadow-2xl hover:shadow-3xl hover:shadow-yellow-600/60 transition transform hover:scale-110 active:scale-95 border border-yellow-400/30 hover:border-yellow-200">
              <span>START SHOPPING</span>
              <i className="fa-solid fa-bolt text-yellow-300"></i>
            </Link>

            <Link to="/stores" className="glass px-12 py-7 rounded-3xl text-xl font-bold hover:bg-white/15 transition border-2 border-yellow-400/40 hover:border-yellow-300/70 transform hover:scale-110 active:scale-95 flex items-center gap-3">
          ...
          <div className="mt-20 flex flex-wrap items-center gap-10 md:gap-16 animate-slide-in-left" style={{ animationDelay: '0.9s', animationFillMode: 'both' }}>
